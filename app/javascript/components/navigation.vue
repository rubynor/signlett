    ...
    <v-row>
        ...
        >
            ...
            >
                ...
                <span v-if="$vuetify.breakpoint.mdAndUp" class="align-self-md-center float-right mr-12"><v-icon left color="primary">mdi-alpha-s-circle-outline</v-icon>{{user.firstName}} {{user.lastName}}</span>
            </v-bottom-navigation>
        </v-col>
    </v-row>
    </span>
