...
ActiveRecord::Schema.define(version: 2020_03_25_135139) do
  ...
  create_table "documents", force: :cascade do |t|
    ...
    t.index ["email_token"], name: "index_documents_on_email_token", unique: true
  ...
  add_foreign_key "recipients", "documents"
end
